...
export const docsNav: DocNavGroup[] = [
  ...
  },
  {
    title: 'Container',
    items: [
      { id: 'container/aimap', name: 'AiMap Container', icon: 'map' },
    ],
  },
  {
    title: 'Map Engines',
    items: [
      { id: 'engines/gaode', name: 'Gaode Map', icon: 'map' },
      { id: 'engines/maplibre', name: 'MapLibre', icon: 'public' },
      { id: 'engines/mapbox', name: 'Mapbox', icon: 'travel_explore' },
      { id: 'engines/tianditu', name: 'Tianditu Map', icon: 'flag' },
      { id: 'engines/tencent', name: 'Tencent Map', icon: 'chat' },
      { id: 'engines/baidu', name: 'Baidu Map', icon: 'explore' },
      { id: 'engines/google', name: 'Google Map', icon: 'language' },
      { id: 'engines/independent', name: 'Independent Engine', icon: 'developer_board' },
    ],
  },
  {
    title: 'Base Layers',
