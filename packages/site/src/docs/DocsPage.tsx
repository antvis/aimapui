...
const docToDemoMap: Record<string, string> = {
  ...
  // 控件
  'controls/zoom-control': 'control/MapControls',
  'controls/fullscreen-control': 'control/MapControls',
  'controls/geo-locate-control': 'control/MapControls',
  'controls/export-image-control': 'control/MapControls',
  'controls/map-theme-control': 'control/MapControls',
