...
const config: DocsThemeConfig = {
  ...
  footer: {
    content: (
      <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
        <span style={{ fontSize: '0.85rem', color: 'var(--muted-foreground)' }}>© 2026 AntV · aimapkit</span>
        <div style={{ display: 'flex', gap: 20, fontSize: '0.85rem' }}>
          ...
          <a href="https://github.com/antvis/aimapkit" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--muted-foreground)', textDecoration: 'none' }}>GitHub</a>
        </div>
      </div>
    )
  },
  head: (
    <>
      ...
      <meta property="og:title" content="aimapkit - Schema 驱动的 React 地图可视化" />
